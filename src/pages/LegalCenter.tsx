      ...
      <main className="relative overflow-hidden">
        ...
        <section className="max-w-5xl mx-auto px-6 pt-24 pb-12 relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#7FE620]/20 border-2 border-[#7FE620] mb-8">
            <span className="text-xs font-bold text-[#1F1F1F] tracking-wider uppercase">PocketHost Legal Center</span>
          </div>

          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-5">PocketHost Legal Center</h1>
          ...
          <div className="rounded-2xl border-2 border-black/10 bg-white/90 p-6 md:p-8 shadow-[0_10px_40px_rgba(0,0,0,0.06)] mb-8">
            <p className="text-black/70 leading-relaxed text-base md:text-lg">
              Welcome to the PocketHost Legal Center. This page gives you quick access to our legal documents and explains your choices.
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-5 mb-10">
            <a href="https://pockethost.online/privacy" className="rounded-xl border-2 border-black/10 p-5 bg-white hover:border-[#7FE620] transition-colors">
              ...
              <p className="text-black/60 mt-2">https://pockethost.online/privacy</p>
            </a>

            <a href="https://pockethost.online/terms" className="rounded-xl border-2 border-black/10 p-5 bg-white hover:border-[#7FE620] transition-colors">
              <p className="text-xs uppercase tracking-wider text-black/50 font-bold mb-1">Quick Link</p>
              <h2 className="text-2xl font-extrabold">Terms of Service</h2>
              <p className="text-black/60 mt-2">https://pockethost.online/terms</p>
            </a>
          </div>

          <div className="grid md:grid-cols-2 gap-5 mb-12">
            <a href="mailto:contact@pockethost.online" className="rounded-xl border-2 border-black/10 p-5 bg-[#f9fff0] hover:border-[#7FE620] transition-colors">
              ...
              <p className="text-black/60 mt-2">contact@pockethost.online</p>
            </a>

            <a href="mailto:support@pockethost.online" className="rounded-xl border-2 border-black/10 p-5 bg-[#f6fbff] hover:border-[#7FE620] transition-colors">
              <p className="text-xs uppercase tracking-wider text-black/50 font-bold mb-1">Contact</p>
              <h3 className="text-xl font-extrabold">Support</h3>
              <p className="text-black/60 mt-2">support@pockethost.online</p>
            </a>
          </div>

          <div className="space-y-5">
            <section className="rounded-xl border-2 border-black/10 p-6 bg-white">
              <h2 className="text-2xl font-extrabold mb-2">About PocketHost</h2>
              <p className="text-black/70">PocketHost is a mobile app for hosting and managing a Minecraft server. The app is built by a solo developer who loves to game.</p>
            </section>

            <section className="rounded-xl border-2 border-black/10 p-6 bg-white">
              <h2 className="text-2xl font-extrabold mb-2">Your Privacy Choices</h2>
              <p className="text-black/70 mb-3">PocketHost includes in-app controls for optional data processing, including:</p>
            ...
            <section className="rounded-xl border-2 border-black/10 p-6 bg-white">
              ...
              <p className="text-black/70">Terms of Service explains the rules for using PocketHost and related services.</p>
            </section>

            <section className="rounded-xl border-2 border-black/10 p-6 bg-white">
              <h2 className="text-2xl font-extrabold mb-2">Children</h2>
              <p className="text-black/70">PocketHost is not intended for children under 13 without parental involvement.</p>
            </section>
            ...
            <section className="rounded-xl border-2 border-black/10 p-6 bg-white mb-6">
              ...
              <p className="text-black/70">For privacy requests: <a className="underline decoration-[#7FE620] underline-offset-4" href="mailto:contact@pockethost.online">contact@pockethost.online</a></p>
              <p className="text-black/70">For support: <a className="underline decoration-[#7FE620] underline-offset-4" href="mailto:support@pockethost.online">support@pockethost.online</a></p>
            </section>
          </div>
        </section>
      </main>
